...
<style>
    ...
    .info-list-condensed dt { font-weight: normal; color: #5a5c69; padding-top: 0.25rem; padding-bottom: 0.25rem;} /* Padding disesuaikan */
    .info-list-condensed dd { font-weight: 500; padding-top: 0.25rem; padding-bottom: 0.25rem;} /* Padding disesuaikan */
    .card-detail-section .card-title { color: #007bff !important; }
    /* Garis pemisah hr.item-divider tidak diperlukan lagi, bisa dihapus dari CSS jika mau */
    ...
    /* PERUBAHAN 1: Gaya untuk Kartu Export (Tanpa Ikon Folder) */
    .card-export-simple .card-body {
        padding: 1rem; /* Padding standar */
        text-align: center; /* Agar teks dan tombol ditengah */
    }
    .card-export-simple .export-text-simple {
        font-size: 0.875rem;
        color: #495057;
        margin-bottom: 1rem; /* Jarak lebih ke tombol */
    }
    .card-export-simple .btn-download-excel-simple {
        font-size: 0.9rem;
        /* Tidak perlu btn-block jika ingin tombol menyesuaikan teksnya */
    }
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-7 mb-4 mb-lg-0 d-flex">
            <div class="card shadow-sm card-detail-section h-100 w-100">
                {{-- PERUBAHAN 2: Tanggal Pengajuan di Card Header --}}
                ...
                <div class="card-body p-3">
                    {{-- PERUBAHAN 2: Garis pemisah dihapus --}}
                    <dl class="row info-list-condensed mb-0">
                        ...
                        {{-- <div class="col-12"><hr class="item-divider"></div> --}} {{-- Dihapus --}}
                        ...
                        {{-- <div class="col-12"><hr class="item-divider"></div> --}} {{-- Dihapus --}}
                        {{-- Tanggal Pengajuan sudah pindah ke header --}}
                        {{-- PERUBAHAN 2: ID Sistem dikomentari --}}
                        {{--
        ...
        <div class="col-lg-5 d-flex flex-column">
            ...
            {{-- PERUBAHAN 1: Kartu Export Tanpa Ikon Folder --}}
            <div class="card shadow-sm card-export-simple">
                <div class="card-body">
                    <p class="export-text-simple">
                        Unduh data pengajuan lengkap dalam format Excel (XLSX) untuk arsip atau analisis lebih lanjut.
                    </p>
                    <a href="{{ route('tenagakerja.exportExcel', ['id' => $item->id]) }}" class="btn btn-success btn-download-excel-simple">
    ...
    {{-- Data Anggota Keluarga (Tidak Berubah dari segi HTML, hanya CSS padding dt/dd info-list-condensed) --}}
    <div class="row mt-4">
