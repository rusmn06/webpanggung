            ...
            <div class="card shadow-sm card-detail-section">
                <div class="card-body p-3">
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-start">
                        ...
                        <div class="mb-2 mb-sm-0 pr-sm-3"> {{-- pr-sm-3: beri jarak kanan di layar besar --}}
                            {{-- Baris untuk Nama Responden dan Nama Pendata --}}
                            <div class="d-flex flex-column flex-sm-row"> {{-- Kolom di mobile, Baris di desktop --}}

                            {{-- Item Pertama (Responden) --}}
                            <div class="mb-3 mb-sm-0 mr-sm-4"> {{-- Margin bawah di mobile (mb-3), Margin kanan di desktop (mr-sm-4) --}}
                            ...
                            {{-- Baris untuk Lokasi (tanpa label, pakai koma) --}}
                            <p class="card-text mb-1"><small class="text-muted">
                                {{-- Pastikan variabel $item->provinsi tersedia --}}
                                {{ $item->provinsi ?? 'Provinsi N/A' }},
                                Kota/Kab. {{ $item->kabupaten }},
                                Kec. {{ $item->kecamatan }},
                                Desa/Kelurahan {{ $item->desa }},
                                RT.{{ $item->rt }} / RW.{{ $item->rw }}
                            </small></p>

                            {{-- Baris untuk Tanggal Pengajuan --}}
