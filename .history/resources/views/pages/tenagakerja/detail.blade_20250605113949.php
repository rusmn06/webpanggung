...
<style>
    ...
    .table-scroll-indicator {
        font-size: 0.875rem; /* Sedikit lebih besar dari default small, bisa disesuaikan */
        color: #5a5c69; /* Warna yang cukup terlihat namun tidak mencolok */
        padding: 0.5rem 0;
        /* background-color: #f8f9fa; /* Contoh jika ingin sedikit latar belakang */
        /* border-top: 1px solid #e3e6f0; */ /* Contoh jika ingin garis pemisah */
    }
            ...
            <div class="card shadow-sm card-export-actions flex-grow-1">
                <div class="card-body">
                    <p class="export-text-description">
                        Silakan unduh data pengajuan lengkap ini dalam format Excel (XLSX) untuk keperluan arsip atau analisis data lebih lanjut,
                        apabila Anda mengalami kendala, membutuhkan panduan teknis, atau memiliki pertanyaan lainnya,
                        jangan ragu untuk menghubungi Administrator.
                    </p>
            ...
            <div class="card shadow-sm card-detail-section">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive mt-3">
                        ...
                        {{-- BARIS BARU UNTUK PANDUAN GESER TABEL --}}
    {{-- Muncul di bawah layar 'large' (lg breakpoint di Bootstrap, biasanya < 992px) --}}
    {{-- 'd-lg-none' berarti 'display: none' di layar large ke atas --}}
    {{-- 'd-block' akan membuatnya 'display: block' di layar di bawah large --}}
    <div class="text-center mt-2 table-scroll-indicator d-block d-lg-none">
        <i class="fas fa-arrows-alt-h" aria-hidden="true"></i> {{-- Ikon opsional dari Font Awesome --}}
