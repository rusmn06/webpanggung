...
<div class="container-fluid">
    {{-- Judul Halaman dan Tombol Kembali & Ekspor --}}
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div> {{-- Wrapper untuk tombol-tombol di kanan --}}
            {{-- TOMBOL EKSPOR EXCEL BARU --}}
            <a href="{{ route('tenagakerja.exportExcel', ['id' => $item->id]) }}" class="btn btn-sm btn-success shadow-sm mr-2">
                <i class="fas fa-file-excel fa-sm"></i> Export ke Excel
            </a>
            {{-- AKHIR TOMBOL EKSPOR EXCEL BARU --}}
