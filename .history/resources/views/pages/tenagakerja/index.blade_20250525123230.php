...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3 mt-4">
        ...
        {{-- Input untuk Pencarian - dipindah ke sini --}}
        @if(!$items->isEmpty())
        <div id="searchRiwayatInputContainer" class="ml-sm-3">
            <input type="text" id="searchRiwayatInput" class="form-control form-control-sm" placeholder="Cari riwayat...">
        </div>
        @endif
    </div>
            ...
            @foreach($items as $item)
                <div class="col-xl-4 col-lg-6 mb-4 submission-card-wrapper">
                    <div class="card submission-card shadow-sm h-100">
                        ...
                        <div class="card-footer bg-light text-right py-2 px-3"> {{-- text-right agar tombol ke kanan --}}
                            {{-- Tombol Lihat Detail tidak lagi dikomentari --}}
