...
<div class="container-fluid">
        ...
        <div class="col-12 mb-4">
            <div class="card shadow-sm card-detail-section">
                ...
                <div class="card-body p-3">
                    {{-- PERUBAHAN 1: Tata letak disederhanakan & Format Tanggal/ID diubah --}}
                    <dl class="row info-list-condensed mb-0">
                        <dt class="col-sm-4 col-md-3">Nama Pendata</dt>
                        <dd class="col-sm-8 col-md-9">{{ $item->nama_pendata }}</dd>

                        <dt class="col-sm-4 col-md-3">Nama Responden</dt>
                        <dd class="col-sm-8 col-md-9">{{ $item->nama_responden }}</dd>

                        <dt class="col-sm-4 col-md-3 pt-2">Provinsi</dt>
                        <dd class="col-sm-8 col-md-9 pt-2">{{ $item->provinsi }}</dd>

                        <dt class="col-sm-4 col-md-3">Kota / Kab</dt>
                        <dd class="col-sm-8 col-md-9">{{ $item->kabupaten }}</dd>

                        <dt class="col-sm-4 col-md-3">Kecamatan</dt>
                        <dd class="col-sm-8 col-md-9">{{ $item->kecamatan }}</dd>

                        <dt class="col-sm-4 col-md-3">Desa / Kelurahan</dt>
                        <dd class="col-sm-8 col-md-9">{{ $item->desa }}</dd>

                        <dt class="col-sm-4 col-md-3">RT / RW</dt>
                        <dd class="col-sm-8 col-md-9">{{ $item->rt }} / {{ $item->rw }}</dd>

                        <dt class="col-sm-4 col-md-3 pt-2">Tanggal Pengajuan</dt>
                        <dd class="col-sm-8 col-md-9 pt-2">{{ \Carbon\Carbon::parse($item->tgl_pembuatan)->isoFormat('dddd, D MMMM YYYY - HH:mm') }}</dd>

                        <dt class="col-sm-4 col-md-3">ID Sistem</dt>
                        <dd class="col-sm-8 col-md-9">RT-{{ $item->id }}</dd>
                    </dl>
                </div>
            </div>
        </div>
    ...
    {{-- PERUBAHAN 2: Kartu Catatan Penting Baru --}}
    <div class="row">
        <div class="col-12 mb-4">
            <div class="card shadow-sm card-detail-section card-important-note">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold card-title"><i class="fas fa-exclamation-triangle icon-warning"></i> Catatan Penting & Tindakan</h6>
                    {{-- Tombol Export dipindahkan ke sini --}}
                ...
                <div class="card-body">
                    <p class="mb-2">Mohon luangkan waktu sejenak untuk <strong>memverifikasi kembali semua detail data</strong> yang telah Anda ajukan. Pastikan tidak ada kekeliruan atau informasi yang terlewat.</p>
                    <p class="mb-0">Jika Anda menemukan ketidaksesuaian atau memerlukan perubahan data, jangan ragu untuk segera <strong>menghubungi Administrator Sistem</strong> kami agar dapat dibantu lebih lanjut. Keakuratan data Anda sangat penting bagi kami.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12 mb-4">
            <div class="card shadow-sm card-detail-section">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    {{-- Tombol export sudah dipindah ke kartu catatan penting --}}
                </div>
                <div class="card-body">
                    <div class="row">
