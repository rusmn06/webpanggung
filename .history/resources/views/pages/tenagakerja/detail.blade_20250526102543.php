...
<style>
    ...
    .info-list-condensed dt, .info-list-condensed dd {
        padding-top: .35rem; padding-bottom: .35rem; margin-bottom: 0.25rem; /* Sedikit margin bawah untuk dd */
        font-size: 0.875rem; line-height: 1.4;
    }
    .info-list-condensed dt { font-weight: 600; color: #5a5c69; } /* Label sedikit bold */
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                ...
                {{-- Tombol close bisa dihilangkan agar user memilih aksi di footer --}}
            </div>
            ...
            <div class="modal-footer justify-content-center">
                {{-- Tombol ini mengarah ke daftar pengajuan user ('tenagakerja.index' yang menampilkan UserTenagaKerjaController@index) --}}
                <a href="{{ route('tenagakerja.index') }}" class="btn btn-outline-primary">
                    <i class="fas fa-list-alt"></i> Lihat Riwayat Pengajuan
                </a>
                {{-- Tombol ini mengarah ke form wizard step 1 ('tkw.step1') --}}
...
@push('scripts')
{{-- Pastikan jQuery dan Bootstrap JS sudah dimuat di layout utama (layouts.main) --}}
@if(session('show_success_modal'))
<script>
