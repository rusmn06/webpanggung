...
@push('styles')
    {{-- DataTables CSS tidak lagi dibutuhkan jika kita tidak menggunakan tabel --}}
                ...
                <div class="col-xl-4 col-lg-6 mb-4 submission-card-wrapper">
                    <div class="card submission-card shadow-sm h-100">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary card-title-search">Pengajuan Ke-{{ $item->id }}</h6>
                            @php
