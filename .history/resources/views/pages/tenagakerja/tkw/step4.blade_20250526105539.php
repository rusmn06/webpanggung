    ...
    <div class="card-body">
        <form action="{{ route('tkw.step4') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <label for="ttd_pendata">Upload Tanda Tangan (PNG/JPG | Max: 2MB)</label>
                    <input type="file" name="ttd_pendata" id="ttd_pendata" accept="image/png, image/jpeg"
            ...
            <div class="d-flex justify-content-between mt-4">
                <a href="{{ route('tkw.step3') }}" class="btn btn-outline-secondary btn-back">
