...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid py-4">
                    ...
                    <div class="card shadow rounded mb-5 form-container">
                        ...
                        <div class="card-body">
                            <form action="{{ route('tkw.step1') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <!-- Second row - RT/RW and date (inline) -->
    ...
    <script>
        $(document).ready(function() {
            // Check screen width and toggle sidebar automatically for large screens
            function checkWidth() {
