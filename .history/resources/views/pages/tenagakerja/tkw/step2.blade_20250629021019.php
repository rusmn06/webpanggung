...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function enforceNikMaxLength(event) {
        // Cek apakah event terjadi pada input NIK
    ...
    // Terapkan listener ke container utama. Ini akan menangani semua input NIK,
    // baik yang lama maupun yang baru ditambahkan.
    if (container) {
        container.addEventListener('input', enforceNikMaxLength);
    }
    
    // --- KODE LAMA ANDA UNTUK TAMBAH/HAPUS (TETAP SAMA) ---
    ...
    if (addButton) {
        addButton.addEventListener('click', function () {
            ...
            // Hapus value dari input di template sebelum ditambahkan
