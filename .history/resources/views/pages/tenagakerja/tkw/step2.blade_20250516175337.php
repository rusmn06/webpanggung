...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('tkw.step1') }}" class="btn btn-secondary btn-sm">Kembali</a>
    </div>

    <!-- Tombol Edit -->
    <div class="mb-3">
        <a href="{{ route('tkw.edit') }}" class="btn btn-warning btn-sm">Edit</a>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-3">
                ...
                <select name="jenis_pekerjaan" id="jenis_pekerjaan"
                    ...
                    <option value="2" {{ old('jenis_pekerjaan', $data['jenis_pekerjaan'] ?? '') == 2 ? 'selected' : '' }}>Karyawan, Honorer, Swasta</option>
                    <option value="3" {{ old('jenis_pekerjaan', $data['jenis_pekerjaan'] ?? '') == 3 ? 'selected' : '' }}>Wiraswasta</option>
                    <option value="4" {{ old('jenis_pekerjaan', $data['jenis_pekerjaan'] ?? '') == 4 ? 'selected' : '' }}>Petani, Nelayan, Peternak</option>
                    <option value="5" {{ old('jenis_pekerjaan', $data['jenis_pekerjaan'] ?? '') == 5 ? 'selected' : '' }}>Lainnya</option>
                </select>
