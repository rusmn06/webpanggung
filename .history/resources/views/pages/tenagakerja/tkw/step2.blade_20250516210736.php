            ...
            <form action="{{ route('tkw.step2') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="nama" value="{{ old('nama', $data['nama'] ?? '') }}">
                        @error('nama')
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="nik" class="form-control @error('nik') is-invalid @enderror" id="nik" value="{{ old('nik', $data['nik'] ?? '') }}">
                        @error('nik')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <select name="nuk" class="form-control @error('nuk') is-invalid @enderror" id="nuk">
                            ...
                            <option value="3" {{ old('nuk', $data['nuk'] ?? '') == 3 ? 'selected' : '' }}>3</option>
                            <option value="4" {{ old('nuk', $data['nuk'] ?? '') == 4 ? 'selected' : '' }}>4</option>
                            <option value="5" {{ old('nuk', $data['nuk'] ?? '') == 5 ? 'selected' : '' }}>5</option>
                            <option value="6" {{ old('nuk', $data['nuk'] ?? '') == 6 ? 'selected' : '' }}>6</option>
                            <option value="7" {{ old('nuk', $data['nuk'] ?? '') == 7 ? 'selected' : '' }}>7</option>
                            <option value="8" {{ old('nuk', $data['nuk'] ?? '') == 8 ? 'selected' : '' }}>8</option>
                            <option value="9" {{ old('nuk', $data['nuk'] ?? '') == 9 ? 'selected' : '' }}>9</option>
                            <option value="10" {{ old('nuk', $data['nuk'] ?? '') == 10 ? 'selected' : '' }}>10</option>
                            <option value="11" {{ old('nuk', $data['nuk'] ?? '') == 11 ? 'selected' : '' }}>11</option>
                            <option value="12" {{ old('nuk', $data['nuk'] ?? '') == 12 ? 'selected' : '' }}>12</option>
                            <option value="13" {{ old('nuk', $data['nuk'] ?? '') == 13 ? 'selected' : '' }}>13</option>
                            <option value="14" {{ old('nuk', $data['nuk'] ?? '') == 14 ? 'selected' : '' }}>14</option>
                            <option value="15" {{ old('nuk', $data['nuk'] ?? '') == 15 ? 'selected' : '' }}>15</option>
                            <option value="16" {{ old('nuk', $data['nuk'] ?? '') == 16 ? 'selected' : '' }}>16</option>
                            <option value="17" {{ old('nuk', $data['nuk'] ?? '') == 17 ? 'selected' : '' }}>17</option>
                            <option value="18" {{ old('nuk', $data['nuk'] ?? '') == 18 ? 'selected' : '' }}>18</option>
                            <option value="19" {{ old('nuk', $data['nuk'] ?? '') == 19 ? 'selected' : '' }}>19</option>
                            <option value="20" {{ old('nuk', $data['nuk'] ?? '') == 20 ? 'selected' : '' }}>20</option>
                        </select>
                        @error('nuk')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <select name="sub_jenis_pekerjaan" class="form-control @error('sub_jenis_pekerjaan') is-invalid @enderror" id="sub_jenis_pekerjaan">
                            ...
                            <option value="5" {{ old('sub_jenis_pekerjaan', $data['sub_jenis_pekerjaan'] ?? '') == 5 ? '