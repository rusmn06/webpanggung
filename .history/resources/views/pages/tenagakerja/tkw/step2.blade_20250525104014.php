                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="hdkrt_{{ $index }}">Hubungan Dxgn Kepala Rumah Tangga</label>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="hdkk_{{ $index }}">Hubungan Dgn Kepala Keluarga</label>
    ...
    <div id="member-template" style="display: none;">
        <div class="member-form card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <label>Hubungan Dgn Kepala Rumah Tangga</label>
                    ...
                    <div class="form-group col-md-3">
                        <label>Hubungan Dgn Kepala Keluarga</label>
