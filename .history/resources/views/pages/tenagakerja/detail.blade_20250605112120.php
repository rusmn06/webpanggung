...
<div class="container-fluid">
    ...
    <div class="row d-flex align-items-stretch">
        ...
        <div class="col-lg-5 d-flex flex-column">
            ...
            {{-- PERUBAHAN: Kartu Export dengan Tata Letak yang Diperbaiki --}}
                ...
                <div class="card-body d-flex">
                    <div class="row w-100 align-items-center">
                        <div class="col-md-3 d-none d-md-flex justify-content-center align-items-center">
                            <i class="fas fa-folder-open icon-export-folder-display"></i>
                        </div>
                        {{-- Teks & Tombol --}}
                        <div class="col-12 col-md-9">
                            {{-- Wrapper untuk teks dan tombol agar bisa ditata vertikal --}}
                            <div class="d-flex flex-column h-100 justify-content-center text-center text-md-left">
                                <p class="export-text-description">
                                    Unduh data pengajuan lengkap dalam format Excel (XLSX).
                                </p>
                                <a href="{{ route('tenagakerja.exportExcel', ['id' => $item->id]) }}" class="btn btn-success btn-download-action mt-2 align-self-center align-self-md-start">
