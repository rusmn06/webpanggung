...
@push('styles')
    <style>
        ...
        /* Mengatur lebar container input search */
        #searchRiwayatInputOuterContainer {
             /* Biarkan default atau atur max-width jika perlu untuk keseluruhan baris search */
        }
    </style>
@endpush
    ...
    <div class="card shadow mb-4">   
        <div class="card-body">
            ...
            <div class="row mb-3" id="searchRiwayatInputOuterContainer">
                <div class="col-md-6 col-lg-5"> {{-- Kolom untuk input search, lebar bisa disesuaikan --}}
                ...
                <div class="col-md-6 col-lg-7 d-flex align-items-center"> {{-- Kolom untuk catatan --}}
                    <small class="form-text text-muted mt-2 mt-md-0">
                        Tips: Anda bisa mencari berdasarkan ID Pengajuan (misal: Pengajuan-1/2/3), Nama Responden, Lokasi (Desa/Kecamatan), atau Status.
                    </small>
                </div>
            </div>
            @endif
