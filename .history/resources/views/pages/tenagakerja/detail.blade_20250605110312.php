...
<style>
    ...
    /* PERUBAHAN: Penyesuaian untuk kartu export agar bisa mengisi ruang */
    .card-export-simple {
        display: flex; /* Memungkinkan card-body untuk tumbuh */
    ...
    .card-export-simple .card-body {
        ...
        flex-grow: 1; /* Membuat card-body mengisi kartu */
        padding: 1rem;
        text-align: center;
    }
    ...
    .card-export-simple .btn-download-excel-simple {
        font-size: 0.9rem;
        /* Tombol tidak perlu btn-block jika align-items:center sudah menangani */
    }
...
<div class="container-fluid">
    ...
    {{-- PERUBAHAN: Tambahkan d-flex align-items-stretch pada .row --}}
    <div class="row d-flex align-items-stretch">
        {{-- Kolom Kiri: Informasi Pengajuan --}}
        {{-- d-flex pada kolom agar h-100 pada card anak bekerja dengan baik --}}
        ...
        {{-- d-flex flex-column pada kolom agar anak-anaknya (kartu) bisa diatur secara vertikal --}}
        <div class="col-lg-5 d-flex flex-column">
            ...
            {{-- PERUBAHAN: Tambahkan flex-grow-1 pada kartu export agar mengisi sisa ruang --}}
            <div class="card shadow-sm card-export-simple flex-grow-1">
                <div class="card-body"> {{-- Styling card-body di CSS akan menangani penataan konten --}}
