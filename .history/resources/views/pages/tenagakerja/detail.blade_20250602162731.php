...
<style>
    ...
    /* PERUBAHAN: Gaya untuk Kartu Export Baru */
    .card-export-new {
        /* Tinggi kartu bisa disesuaikan jika ingin sama dengan kartu alert di atasnya,
           namun akan lebih baik jika menyesuaikan konten.
           Untuk menyamakan tinggi, Anda mungkin perlu JavaScript atau CSS Flexbox pada parent (col-lg-5) */
    }
    .card-export-new .icon-excel-wrapper {
        display: flex;
        align-items: center;
        justify-content: center;
        height: 100%; /* Agar ikon ditengah jika kolomnya lebih tinggi */
    }
    .card-export-new .icon-excel-wrapper .fa-file-excel {
        font-size: 3rem; /* Ukuran ikon Excel */
        color: #1D6F42; /* Warna hijau tua khas Excel */
    }
    .card-export-new .export-text {
        font-size: 0.85rem;
        color: #495057;
        margin-bottom: 0.75rem;
    }
    .card-export-new .btn-download-excel {
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-7 mb-4 mb-lg-0 d-flex"> {{-- d-flex agar kartu di dalamnya bisa h-100 --}}
            <div class="card shadow-sm card-detail-section h-100 w-100"> {{-- h-100 dan w-100 --}}
        ...
        <div class="col-lg-5 d-flex flex-column"> {{-- d-flex flex-column untuk mengatur elemen di dalamnya --}}
            ...
            {{-- PERUBAHAN: Kartu Export dengan Desain Baru --}}
            <div class="card shadow-sm card-export-new flex-grow-1"> {{-- flex-grow-1 agar kartu ini mengisi sisa ruang jika memungkinkan --}}
                <div class="card-body d-flex align-items-center"> {{-- d-flex align-items-center untuk menengahkan konten jika tingginya fix --}}
                    <div class="row w-100 align-items-center">
                        <div class="col-10 icon-excel-wrapper">
                        ...
                        <div class="col-8">
                            ...
                            <a href="{{ route('tenagakerja.exportExcel', ['id' => $item->id]) }}" class="btn btn-success btn-block btn-download-excel">
