            ...
            <div class="card-body p-3">
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-start">
                    ...
                    <div class="mb-2 mb-sm-0 pr-sm-3">
                        ...
                        {{-- Bagian Lokasi (Menggunakan Tabel) --}}
                        <div class="mt-3">
                            <table class="table table-borderless table-sm mb-0 location-align-table">
                                <tbody>
                                    <tr>
                                        <td>Provinsi</td>
                                        <td class="px-1">:</td>
                        ...
                        {{-- Bagian Tanggal --}}
                        <p class="card-text mb-0 mt-3"><small class="text-muted">
                    ...
                    <div class="mt-2 mt-sm-0">
                        @php
                            ...
                            $badgeClass = 'badge-light text-dark border'; // Default
