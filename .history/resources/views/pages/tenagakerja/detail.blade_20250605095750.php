...
@push('styles')
<style>
    /* ... (Gaya signature-box, verification-title, info-list-condensed, card-detail-section, card-alert-custom, card-export-folder tetap sama) ... */
    .signature-box {
    ...
    .card-export-folder .card-body { padding: 1rem; }
    .card-export-folder .icon-folder-wrapper .fa-folder-open { font-size: 4.5rem; color: #28a745; line-height: 1;}
    .card-export-folder .export-text-folder { font-size: 0.875rem; color: #495057; margin-bottom: 0.85rem; }
    .card-export-folder .btn-download-excel-folder { font-size: 0.9rem; }

    /* Merapikan Tabel Anggota Keluarga */
    ...
    /* PERUBAHAN 1: Styling untuk NIK yang diformat */
    .table-anggota-keluarga th.th-nik { /* Header NIK */
        width: 190px; /* Lebar tetap untuk kolom NIK header */
        min-width: 190px;
    }
    .table-anggota-keluarga td.td-nik { /* Sel NIK */
        font-family: monospace;
        letter-spacing: 1.5px; /* Spasi antar karakter */
        white-space: nowrap; /* Mencegah NIK ter-wrap */
        text-align: center;
        width: 190px; /* Lebar tetap untuk kolom NIK data */
        min-width: 190px;
    }
...
<div class="container-fluid">
    ...
    {{-- BARIS UTAMA: Info Pengajuan (Kiri) & Kolom Kanan (Alert + Export) (Tidak Berubah) --}}
    <div class="row">
                        ...
                        <table class="table table-bordered table-hover table-sm table-anggota-keluarga">
                            <thead class="thead-light">
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
                                    {{-- PERUBAHAN 1: Tambah kelas untuk header NIK --}}
                                    <th class="th-nik">NIK</th>
                                    <th>Hub. KRT</th>
                                    <th>NUK</th> {{-- Diubah dari No. Urut Kel. --}}
                                    <th>HDKK</th> {{-- Kolom Baru --}}
                                    <th>J. Kelamin</th>
                                    <th>Sts. Kawin</th>
                                    <th>Sts. Kerja</th>
                                    <th>Jns. Kerja</th>
