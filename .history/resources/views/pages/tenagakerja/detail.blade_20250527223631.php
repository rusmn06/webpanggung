                ...
                <div class="card-body p-3">
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-start">
                        <div class="mb-2 mb-sm-0 pr-sm-3">
                            ...
                            {{-- Bagian Lokasi --}}
                            <div class="mt-3">
                                <p class="text-dark mb-1">Provinsi      : {{ $item->provinsi }}</p>
                                <p class="text-dark mb-1">Kota/Kab      : {{ $item->kabupaten }}</p>
                                <p class="text-dark mb-1">Kecamatan     : {{ $item->kecamatan }}</p>
                                <p class="text-dark mb-1">Desa/Kelurahan: {{ $item->desa }}</p>
