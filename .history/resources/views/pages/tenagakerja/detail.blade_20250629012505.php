...
<div class="container-fluid">
    ...
    {{-- 1. Hapus data-backdrop="static" dan data-keyboard="false" dari baris ini --}}
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    ...
                    {{-- 2. Tambahkan tombol close (X) di sini --}}
                ...
                <div class="modal-footer justify-content-center">
                    {{-- 3. Tambahkan tombol "Tutup" untuk menutup modal --}}
                    ...
                    {{-- Tombol Lihat Riwayat bisa dipindahkan ke sini jika mau, atau biarkan seperti di screenshot Anda --}}
