...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12 mb-4"> {{-- Kartu Informasi Pengajuan mengambil lebar penuh --}}
            <div class="card shadow-sm card-detail-section">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    {{-- PERUBAHAN 2: Tombol Export dipindahkan ke sini --}}
                ...
                <div class="card-body p-3">
                    <dl class="row info-list-condensed mb-0">
                        ...
                        {{-- PERUBAHAN 3: Garis Pemisah Antar Grup --}}
                        <div class="col-12"><hr class="item-divider"></div>

                        {{-- Grup Alamat --}}
                        <dt class="col-sm-4 col-md-3">Provinsi</dt>
                        <dd class="col-sm-8 col-md-9">{{ $item->provinsi }}</dd>
                        ...
                        <dt class="col-sm-4 col-md-3">Tanggal Pengajuan</dt>
                        <dd class="col-sm-8 col-md-9">{{ \Carbon\Carbon::parse($item->tgl_pembuatan)->isoFormat('dddd, D MMMM YYYY - HH:mm') }}</dd>
    ...
    {{-- PERUBAHAN 1: Kartu Catatan Penting diubah menjadi Alert --}}
    <div class="row">
        <div class="col-12 mb-4">
            <div class="alert alert-warning alert-important-note" role="alert">
                <h5 class="alert-heading" style="font-size: 1rem;"><i class="fas fa-exclamation-triangle icon-warning"></i> Catatan Penting</h5>
