                ...
                <div class="card-body p-3">
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-start">
                        <div class="mb-2 mb-sm-0 pr-sm-3">
                            ...
                            {{-- Bagian Lokasi --}}
                            <div class="mt-3">
                                <p class="font-weight-normal mb-0">Provinsi: {{ $item->provinsi }}</p>
                                <p class="font-weight-normal mb-0">Kota/Kab: {{ $item->kabupaten }}</p>
                                <p class="font-weight-normal mb-0">Kecamatan: {{ $item->kecamatan }}</p>
                                <p class="font-weight-normal mb-0">Desa/Kelurahan: {{ $item->desa }}</p>
