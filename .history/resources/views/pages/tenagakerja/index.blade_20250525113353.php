...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        {{-- Tombol ini bisa kembali ke dashboard utama pengguna --}}
        <a href="{{ route('user.dashboard') }}" {{-- Sesuaikan nama route dashboard user --}}
    ...
    {{-- Tombol Aksi Utama --}}
    <div class="mb-4">
        <a href="{{ route('tkw.step1') }}" class="btn btn-primary btn-lg btn-icon-split"> {{-- Pastikan route 'tkw.step1' benar --}}
