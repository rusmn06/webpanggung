                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-start">
                        ...
                        <div class="mb-2 mb-sm-0 pr-sm-3"> {{-- pr-sm-3: beri jarak kanan di layar besar --}}
                            ...
                            <h5 class="text-dark mb-2">
                                Nama Responden: <span class="font-weight-normal">{{ $item->nama_responden }}</span>
                                <span class="mx-2">|</span> {{-- Pemisah --}}
                                Nama Pendata: <span class="font-weight-normal">{{ $item->nama_pendata }}</span>
                            </h5>
