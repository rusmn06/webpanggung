                ...
                <div class="card-body p-3">
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-start">
                        <div class="mb-2 mb-sm-0 pr-sm-3">
                            ...
                            <div class="mt-3">
                                <p class="mb-1">Provinsi:</strong> {{ $item->provinsi }}</p>
                                <p class="mb-1">Kota/Kab:</strong> {{ $item->kabupaten }}</p>
                                <p class="mb-1">Kecamatan:</strong> {{ $item->kecamatan }}</p>
                                <p class="mb-1">Desa/Kelurahan:</strong> {{ $item->desa }}</p>
                                <p class="mb-0">RT/RW:</strong> {{ $item->rt }} / {{ $item->rw }}</p>
                            </div>
