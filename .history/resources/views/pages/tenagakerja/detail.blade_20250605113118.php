            ...
            <div class="card shadow-sm card-export-actions flex-grow-1">
                <div class="card-body">
                    <p class="export-text-description">
                        Unduh data pengajuan lengkap ini dalam format Excel (XLSX) untuk keperluan arsip atau analisis data lebih lanjut. Jika Anda mengalami kendala atau memerlukan bantuan, silakan hubungi Administrator.
                    </p>
                    <div class="export-buttons-group mt-auto"> {{ mt-auto untuk mendorong ke bawah jika card-body adalah flex-column & space-between }}
