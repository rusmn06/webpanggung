        ...
        <div class="card shadow-sm card-detail-section">
            <div class="card-body p-3">
                <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-start">
                    {{-- Bagian Kiri: Informasi Responden, Pendata, Lokasi, Tanggal --}}
                    <div class="mb-2 mb-sm-0 flex-grow-1 pr-3"> {{-- flex-grow-1 agar mengambil ruang & pr-3 untuk jarak --}}
                        ...
                        {{-- Baris untuk Lokasi --}}
                        <div class="mb-2">
                             <h6 class="text-dark mb-1">Lokasi:</h6>
                             <p class="card-text mb-0"><small class="text-muted">
                                {{-- Pastikan variabel $item->provinsi dan $item->rt_dusun tersedia --}}
                                Provinsi: {{ $item->provinsi ?? 'Data Tidak Tersedia' }},
                                Kab: {{ $item->kabupaten }},
                                Kec: {{ $item->kecamatan }},
                                Desa: {{ $item->desa }},
                                RT/Dusun: {{ $item->rt_dusun ?? 'Data Tidak Tersedia' }}
                             </small></p>
                        </div>
                    ...
                    <div class="mt-2 mt-sm-0"> {{-- mt-2 untuk jarak di mobile --}}
                        @php
