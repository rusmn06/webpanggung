                            ...
                            <tbody>
                                @forelse ($item->anggotaKeluarga as $anggota)
                                    <tr>
                                        ...
                                        <td>{{ $anggota->nama }}</td>
                                        <td class="td-nik">{{ $anggota->formatted_nik }}</td> {{-- Menggunakan NIK yang diformat --}}
                                        <td class="text-center">{{ $anggota->hdkrt_text }}</td>
                                        <td class="text-center">{{ $anggota->nuk ?? '-' }}</td>
                                        <td class="text-center">{{ $anggota->hdkk_text ?? '-' }}</td> {{-- Menampilkan HDKK --}}
                                        ...
                                        <td class="text-center">{{ $anggota->sub_jenis_pekerjaan_text }}</td> {{-- Menggunakan accessor baru --}}
                                        <td class="text-center">{{ $anggota->pendidikan_terakhir_text }}</td>
                                        <td class="text-right">{{ $anggota->pendapatan_per_bulan_text }}</td> {{-- Menggunakan accessor baru --}}
                                    </tr>
                                @empty
                                    <tr><td colspan="13" class="text-center">Tidak ada data anggota keluarga.</td></tr> {{-- Colspan jadi 13 --}}
                                @endforelse
                            </tbody>
                        </table>
