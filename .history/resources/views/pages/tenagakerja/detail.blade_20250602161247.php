...
<style>
    ...
    /* PERUBAHAN 1: Gaya untuk "Kartu Alert" di kolom kanan atas */
    .card-alert-custom {
        background-color: #e9ecef; /* Warna dari .alert-secondary */
        border: 1px solid #ced4da; /* Border dari .alert-secondary */
        padding: 1rem;
        border-radius: .35rem; /* Sedikit lebih besar dari default card */
        font-size: 0.875rem;
        line-height: 1.5;
    }
    .card-alert-custom .alert-heading { /* Jika ingin menggunakan heading di dalamnya */
        font-size: 1rem;
        font-weight: 500;
        color: #495057; /* Warna teks heading */
    }
    .card-alert-custom .icon-warning {
        font-size: 1.1rem;
        margin-right: 8px;
        color: #6c757d; /* Warna ikon disesuaikan dengan background */
    }

    /* PERUBAHAN 2: Gaya untuk Tombol Export Baru */
    .btn-export-custom {
        display: flex;
        align-items: center;
        justify-content: space-between; /* Untuk panah di paling kanan */
        padding: 0.75rem 1rem;
        font-size: 0.9rem;
        font-weight: 500;
        color: #007bff; /* Warna teks biru primer */
        background-color: #fff;
        border: 1px solid #dee2e6; /* Border standar kartu */
        border-radius: .35rem;
    ...
    .btn-export-custom .icon-part {
        font-size: 1.5rem; /* Ukuran ikon folder/file */
        margin-right: 10px;
        color: #007bff; /* Warna ikon */
    }
    .btn-export-custom .text-part {
        flex-grow: 1; /* Teks mengambil ruang yang tersedia */
        text-align: left;
    }
    .btn-export-custom .arrow-part {
        font-size: 0.9rem; /* Ukuran panah */
    }
</style>
@endpush
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-7 mb-4 mb-lg-0">
            <div class="card shadow-sm card-detail-section h-100">
                <div class="card-header py-3">
                    {{-- Tombol export sudah dipindah dari sini --}}
        ...
        <div class="col-lg-5">
            {{-- PERUBAHAN 1: "Kartu Alert" di kolom kanan atas --}}
            ...
            {{-- PERUBAHAN 2: Kartu dengan Tombol Export desain baru --}}
            <div class="card shadow-sm">
                <div class="card-body p-2"> {{-- Padding lebih kecil untuk tombol --}}
                    <a href="{{ route('tenagakerja.exportExcel', ['id' => $item->id]) }}" class="btn-export-custom">
                        <span class="icon-part"><i class="fas fa-folder-open"></i></span> {{-- Ganti ikon jika perlu, misal fa-file-excel --}}
                        <span class="text-part">Export Data Pengajuan (Excel)</span>
                        <span class="arrow-part"><i class="fas fa-arrow-right"></i></span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-4"> {{-- mt-4 agar ada jarak dari baris di atasnya --}}
        <div class="col-12 mb-4">
            <div class="card shadow-sm card-detail-section">
                ...
                <div class="card-body">
                    <div class="alert alert-secondary" role="alert" style="font-size: 0.875rem;"> {{-- Tombol close dihapus --}}
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-bordered table-hover table-sm table-anggota-keluarga">
                            {{-- Struktur tabel anggota keluarga (thead, tbody) sama seperti respons sebelumnya --}}
