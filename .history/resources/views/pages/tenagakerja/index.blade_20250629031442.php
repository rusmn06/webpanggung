    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            @if($items->isEmpty())
                ...
                @endif
            @else
                {{-- Jika ada item, tampilkan dalam bentuk kartu --}}
                ...
                {{-- Tampilkan link pagination HANYA jika total item lebih banyak dari item per halaman --}}
                @if ($items->hasPages())
                <div class="mt-3 d-flex justify-content-center">
                    {{-- append(request()->query()) akan memastikan filter pencarian tidak hilang saat pindah halaman --}}
