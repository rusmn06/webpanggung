                ...
                <div class="card-body p-3">
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-start">
                        ...
                        <div class="mb-2 mb-sm-0 pr-sm-3"> {{-- pr-sm-3: beri jarak kanan di layar besar --}}
                            ...
                            <div class="row mb-0">
                                <div class="col-sm-8">
                                    <h6 class="font-weight-normal mb-0">Nama Pendata:</h6>
                                    <p class="text-dark mb-1">{{ $item->nama_pendata }}</p>
                                </div>
                                <div class="col-sm-8">
                                    <h6 class="font-weight-normal mb-0">Nama Responden:</h6>
                                    <p class="text-dark mb-0">{{ $item->nama_responden }}</p>
                                </div>
                            </div>
