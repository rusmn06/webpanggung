    ...
    <table class="table table-bordered table-hover table-sm table-anggota-keluarga">
        <thead class="thead-light">
            <tr>
                <th>No</th>
                <th>Nama</th>
                <th class="th-nik">NIK (Debug)</th>
                <th>Hub. KRT</th>
                <th>NUK</th>
                <th>HDKK</th>
                <th>J. Kelamin</th>
                <th>Sts. Kawin</th>
                <th>Sts. Kerja (Debug)</th>
                <th>Jns. Kerja (Debug)</th>
                <th>Sub Jns. Kerja (Debug)</th>
                <th>Pddk. Akhir</th>
        ...
        <tbody>
            @forelse ($item->anggotaKeluarga as $anggota)
                <tr>
                    ...
                    <td>{{ $anggota->nama }}</td>
                    <td class="td-nik">
                        Raw: [{{ $anggota->getRawOriginal('nik') ?? 'NULL' }}] <br>
                        Len: {{ strlen($anggota->getRawOriginal('nik') ?? '') }} <br>
                        Fmtd: [{{ $anggota->formatted_nik }}]
                    </td>
                    ...
                    <td class="text-center">
                        Raw: [{{ $anggota->getRawOriginal('status_pekerjaan') ?? 'NULL' }}] <br>
                        Acc: {{ $anggota->status_pekerjaan_text }}
                    </td>
                    <td class="text-center">
                        Raw: [{{ $anggota->getRawOriginal('jenis_pekerjaan') ?? 'NULL' }}] <br>
                        Acc: {{ $anggota->jenis_pekerjaan_text }}
                    </td>
                    <td class="text-center">
                        Raw: [{{ $anggota->getRawOriginal('sub_jenis_pekerjaan') ?? 'NULL' }}] <br>
                        Acc: {{ $anggota->sub_jenis_pekerjaan_text }}
                    </td>
