...
<style>
    ...
    .card-export-final .card-body {
        padding: 1rem; /* Padding konsisten */
    }
    .card-export-final .icon-export-folder-display {
        font-size: 3rem; /* Ukuran ikon folder disesuaikan agar pas sebagai ikon pendamping */
    ...
    .card-export-final .btn-download-action {
        font-size: 0.9rem;
        /* Tombol bisa dibuat sedikit lebih kecil atau lebih besar sesuai preferensi */
        /* width: auto; agar tidak full width jika tidak diinginkan */
    }
    ...
    <div class="row d-flex align-items-stretch">
        ...
        <div class="col-lg-5 d-flex flex-column">
            ...
            <div class="card shadow-sm card-export-final flex-grow-1">
                {{-- <div class="card-body d-flex"> {{ Tambahkan d-flex untuk kontrol lebih baik atas row anak }} --}}
                    <div class="row w-100 align-items-center">
                        {{-- Ikon Folder: Hanya tampil di MD ke atas --}}
                        <div class="col-md-3 d-none d-md-flex justify-content-center align-items-center">
                            <i class="fas fa-folder-open icon-export-folder-display"></i> {{-- Ukuran via CSS --}}
                        </div>
                        {{-- Teks & Tombol --}}
