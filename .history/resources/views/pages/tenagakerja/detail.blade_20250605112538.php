...
<style>
    ...
    /* PERUBAHAN: Gaya untuk Kartu Export yang Sangat Minimalis */
    .card-export-minimalist {
        display: flex; /* Memungkinkan card-body untuk tumbuh dan menengahkan */
        flex-direction: column;
    }
    .card-export-minimalist .card-body {
        display: flex;
        flex-direction: column;
        justify-content: center; /* Menengahkan tombol secara vertikal */
        align-items: center;    /* Menengahkan tombol secara horizontal */
        flex-grow: 1;          /* Membuat card-body mengisi kartu */
        padding: 1rem;         /* Padding standar */
    }
    .card-export-minimalist .btn-download-action-minimalist {
        font-size: 0.9rem;
        /* Tidak perlu width: auto; atau btn-block jika sudah ditengahkan oleh parent */
    }
...
<div class="container-fluid">
    ...
    <div class="row d-flex align-items-stretch">
        ...
        <div class="col-lg-5 d-flex flex-column">
            ...
            {{-- PERUBAHAN: Kartu Export Sangat Minimalis (Hanya Tombol) --}}
            <div class="card shadow-sm card-export-minimalist flex-grow-1">
                <div class="card-body">
                    <a href="{{ route('tenagakerja.exportExcel', ['id' => $item->id]) }}" class="btn btn-success btn-download-action-minimalist">
