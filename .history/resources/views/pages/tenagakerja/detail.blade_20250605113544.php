            ...
            <div class="card shadow-sm card-export-actions flex-grow-1">
                <div class="card-body">
                    <p class="export-text-description">
                        Silakan unduh data pengajuan lengkap ini dalam format Excel (XLSX) untuk keperluan arsip atau analisis data lebih lanjut; apabila Anda mengalami kendala, membutuhkan panduan teknis, atau memiliki pertanyaan lainnya, jangan ragu untuk menghubungi Administrator.
                    </p>
