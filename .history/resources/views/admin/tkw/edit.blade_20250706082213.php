...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (radioValidated.checked) {
        ...
        // Kembalikan nilai DB setiap kembali ke validated
        tglValidasiInput.value = dbTglValidasi || today;
        namaVerifikatorInput.value = dbNamaVerifikator;
        if (dbSignatureHTML && signaturePreview.innerHTML.trim() === '') {
            signaturePreview.innerHTML = dbSignatureHTML;
        }
