                    ...
                    <form id="verification-form" action="{{ route('admin.tkw.process', $item->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="custom-control custom-radio mr-4">
                                    <input type="radio" id="status_validated" name="status" value="validated" class="custom-control-input" 
                                        @if(old('status', $item->status_validasi) == 'validated') checked @endif>
                                ...
                                <div class="custom-control custom-radio mr-4">
                                    <input type="radio" id="status_rejected" name="status" value="rejected" class="custom-control-input" 
                                        @if(old('status', $item->status_validasi) == 'rejected') checked @endif>
                                    <label class="custom-control-label" for="status_rejected">Tolak (Rejected)</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="status_pending" name="status" value="pending" class="custom-control-input"
                                        @if(old('status', $item->status_validasi) == 'pending') checked @endif>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="admin_tgl_validasi" id="admin_tgl_validasi" 
                                ...
                                class="form-control @error('admin_tgl_validasi') is-invalid @enderror" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="admin_nama_kepaladusun" id="admin_nama_kepaladusun" 
                                ...
                                class="form-control @error('admin_nama_kepaladusun') is-invalid @enderror" required>
