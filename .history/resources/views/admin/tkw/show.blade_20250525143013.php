    ...
    <div class="row">
        ...
        <div class="col-lg-7 mb-4">
            <div class="card shadow-sm h-100">
                {{-- Header kartu dengan style standar (seperti daftar validasi) --}}
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Informasi Rumah Tangga</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            {{-- Penggunaan <strong> dihilangkan, label dan nilai dipisahkan <br> --}}
        ...
        <div class="col-lg-5 mb-4">
            <div class="card shadow-sm h-100">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Tindakan Validasi</h6>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-12 mb-4">
            <div class="card shadow-sm">
                 {{-- Header kartu dengan style standar --}}
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Data Anggota Keluarga</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        {{-- Tabel dibuat lebih konsisten dengan tabel di halaman daftar validasi --}}
                        <table class="table table-bordered table-hover table-sm" style="font-size: 0.9rem;">
                            <thead class="thead-light"> {{-- thead-light seperti di halaman daftar --}}
                                <tr>
                            ...
                            <tbody>
                                @forelse ($item->anggotaKeluarga as $anggota)
                                    <tr>
                                        ...
                                        <td>{{ $anggota->nama }}</td>
                                        <td>'{{ $anggota->nik }}</td> {{-- Tanda petik agar NIK tidak jadi scientific di Excel --}}
...
<script>
// ... (Script preview gambar bisa tetap sama seperti yang Anda punya) ...
</script>
@endpush
@endsection