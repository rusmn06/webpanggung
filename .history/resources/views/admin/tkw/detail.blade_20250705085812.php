    ...
    <div class="col-lg-5 d-flex flex-column">
        ...
        <div class="card shadow-sm flex-grow-1">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <div class="mt-auto">
                    <a href="{{ route('admin.tkw.show', $item->id) }}" class="btn btn-primary btn-icon-split mb-2">
                        <span class="icon text-white-50"><i class="fas fa-stamp"></i></span>
                        <span class="text">Buka Halaman Verifikasi</span>
                    </a>
                    {{-- DIREVISI: Tombol diubah menjadi 'Edit Data' --}}
                    <a href="{{ route('admin.tkw.edit', $item->id) }}" class="btn btn-warning btn-icon-split">
                        <span class="icon text-white-50"><i class="fas fa-edit"></i></span>
                        <span class="text">Edit Data Pengajuan</span>
                    </a>
                </div>
            </div>
        </div>
