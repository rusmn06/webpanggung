                ...
                <div class="row align-items-stretch">
                    <div class="col-md-6 mb-4 mb-md-0">
                        ...
                        <div class="form-group">
                            <label for="verif_nama_pendata">Nama Lengkap Pendata</label><input type="text" name="verif_nama_pendata" id="verif_nama_pendata" value="{{ old('verif_nama_pendata', $item->verif_nama_pendata) }}" class="form-control @error('verif_nama_pendata') is-invalid @enderror" readonly></div>
