    ...
    <div class="row">
            ...
            <div class="card shadow-sm card-detail-section h-100">
                ...
                <div class="card-body py-2 px-3">
                    <dl class="dl-horizontal info-list-lined mb-0">
                        ...
                        <div class="row"><dt class="col-sm-4">RT / RW</dt><dd class="col-sm-8">{{ str_pad($item->rt, 2, '0', STR_PAD_LEFT) }} / {{ str_pad($item->rw, 2, '0', STR_PAD_LEFT) }}</dd></div>
                    </dl>
                </div>
            </div>
        </div>
        <div class="col-lg-5 mb-4">
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body">
                    {{-- Menggunakan data rekapitulasi yang sudah tersimpan untuk performa lebih baik --}}
