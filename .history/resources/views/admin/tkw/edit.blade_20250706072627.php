                ...
                <div class="card shadow-sm h-100" id="recap-card">
                    ...
                    <div class="card-body">
                        <dl class="row mb-0">
                            ...
                            <dt class="col-sm-8">Tdk/Belum Bekerja</dt><dd class="col-sm-4"><input type="number" id="recap_jart_tb" class="form-control form-control-sm" readonly></dd>                                <dt class="col-sm-8">Masih Sekolah</dt><dd class="col-sm-4"><input type="number" id="recap_jart_ms" class="form-control form-control-sm" readonly></dd>
                            </dl>
                            <hr class="my-2">
