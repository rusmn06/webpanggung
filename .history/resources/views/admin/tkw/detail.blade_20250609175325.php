...
<style>
    ...
    .signature-box img {
    height: 80px; /* Atur tinggi yang pasti untuk "kotak" gambar */
    width: 100%;  /* Atur lebar agar memenuhi kontainer */
    object-fit: contain; /* Ini kuncinya: gambar akan pas tanpa distorsi */
    border: 1px solid #eee; /* Tetap berikan border agar terlihat */
}
