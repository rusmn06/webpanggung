    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <div class="alert alert-secondary alert-petunjuk-tabel" role="alert">
                ...
                {{-- PETUNJUK TABEL DENGAN STYLE BARU --}}
                <ul class="mb-0 pl-3">
...
{{-- Modal Konfirmasi Verifikasi (Tidak Berubah) --}}
...
@push('scripts')
{{-- Seluruh script dari jawaban sebelumnya tetap sama dan sudah lengkap --}}
<script>
document.addEventListener('DOMContentLoaded', function() {
    ...
    // === 5. LOGIKA UNTUK SUBMIT FINAL DARI MODAL ===
    if (confirmSubmitBtn) {
    ...
    // === Jalankan fungsi saat halaman dimuat untuk set status awal ===
    toggleCommentState();
