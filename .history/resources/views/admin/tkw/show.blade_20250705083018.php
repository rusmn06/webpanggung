...
<style>
    ...
    .comment-tag { 
        cursor: pointer; user-select: none; border: 1px solid #d1d3e2; margin-right: 5px; margin-bottom: 5px; display: inline-block; }
            ...
            <div class="row">
                <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <div class="signature-box">
                        @if($item->ttd_pendata)
                            {{-- PERBAIKAN DI SINI: tambahkan style --}}
                ...
                <div class="col-md-6">
                    ...
                    @if($item->status_validasi != 'pending' && $item->admin_tgl_validasi)
                        <div class="text-center mb-2">Tgl: <strong>{{ \Carbon\Carbon::parse($item->admin_tgl_validasi)->isoFormat('D MMM YYYY') }}</strong></div>
                        <div class="signature-box">
                    ...
                    @else
                        <div class="text-center mb-2">Tgl: <strong>-</strong></div>
                        <div class="signature-box">
