        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 mb-3"><label for="provinsi">Provinsi</label><input type="text" name="provinsi" id="provinsi" value="{{ old('provinsi', $item->provinsi) }}" class="form-control @error('provinsi') is-invalid @enderror"></div>
                            <div class="col-md-4 mb-3"><label for="kabupaten">Kabupaten</label><input type="text" name="kabupaten" id="kabupaten" value="{{ old('kabupaten', $item->kabupaten) }}" class="form-control @error('kabupaten') is-invalid @enderror"></div>
                            <div class="col-md-4 mb-3"><label for="kecamatan">Kecamatan</label><input type="text" name="kecamatan" id="kecamatan" value="{{ old('kecamatan', $item->kecamatan) }}" class="form-control @error('kecamatan') is-invalid @enderror"></div>
                            <div class="col-md-4 mb-3"><label for="desa">Desa/Kelurahan</label><input type="text" name="desa" id="desa" value="{{ old('desa', $item->desa) }}" class="form-control @error('desa') is-invalid @enderror"></div>
                            <div class="col-md-2 mb-3"><label for="rt">RT</label><input type="number" name="rt" id="rt" value="{{ old('rt', $item->rt) }}" class="form-control @error('rt') is-invalid @enderror" min="0"></div>
                            <div class="col-md-2 mb-3"><label for="rw">RW</label><input type="number" name="rw" id="rw" value="{{ old('rw', $item->rw) }}" class="form-control @error('rw') is-invalid @enderror" min="0"></div>
                            <div class="col-md-4 mb-3"><label for="tgl_pembuatan">Tgl. Pembuatan</label><input type="date" name="tgl_pembuatan" id="tgl_pembuatan" value="{{ old('tgl_pembuatan', \Carbon\Carbon::parse($item->tgl_pembuatan)->format('Y-m-d')) }}" class="form-control @error('tgl_pembuatan') is-invalid @enderror"></div>
                            <div class="col-md-6 mb-md-0"><label for="nama_pendata">Nama Pendata</label><input type="text" name="nama_pendata" id="nama_pendata" value="{{ old('nama_pendata', $item->nama_pendata) }}" class="form-control @error('nama_pendata') is-invalid @enderror"></div>
                            <div class="col-md-6 mb-md-0"><label for="nama_responden">Nama Responden</label><input type="text" name="nama_responden" id="nama_responden" value="{{ old('nama_responden', $item->nama_responden) }}" class="form-control @error('nama_responden') is-invalid @enderror"></div>
                        </div>
                    </div>
                </div>
                {{-- Kartu Rekapitulasi --}}
                <div class="card shadow-sm mb-4 h-100" id="recap-card">
            ...
            <div class="col-lg-5 mb-4">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3"><label for="admin_ttd_pendata" class="form-label">Upload TTD Verifikator</label><input type="file" name="admin_ttd_pendata" id="admin_ttd_pendata" class="form-control-file @error('admin_ttd_pendata') is-invalid @enderror"><small class="text-muted d-block">Kosongkan jika tidak ingin mengubah.</small><div id="signature-preview" class="mt-2">@if($item->admin_ttd_pendata)<img src="{{asset('storage/ttd/admin/'.$item->admin_ttd_pendata)}}" style="max-height: 80px; border: 1px solid #ddd;">@endif</div>@error('admin_ttd_pendata')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror</div>
