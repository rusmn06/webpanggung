...
@section('title', 'Daftar Validasi') {{-- Judul diubah --}}
...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Validasi Rumah Tangga (Pending)</h1>
    </div>
                    ...
                    <tbody>
                        @forelse($items as $item) {{-- $items sekarang adalah RumahTangga --}}
                            <tr>
                                ...
                                <td>
                                    {{-- Link tetap ke show, tapi sekarang ID-nya adalah ID RumahTangga --}}
