...
@section('content')
    ...
    <div class="row d-flex align-items-stretch">
        ...
        {{-- Revisi dengan Logika Kondisional --}}
        {{-- Ganti seluruh blok kolom kanan Anda dengan ini --}}
        <div class="col-lg-5 d-flex flex-column">
            ...
            @if($item->status_validasi == 'rejected')
                <div class="card-alert-custom bg-danger text-white border-danger mb-3 shadow-sm">
                    <h5 class="alert-heading"><i class="fas fa-times-circle mr-2"></i> Pengajuan Ditolak</h5>
                    <p>Pengajuan Anda ditolak oleh admin. Silakan klik tombol <strong>Edit Data</strong> di bawah untuk memperbaiki.</p>
            ...
            @else
                <div class="card-alert-custom mb-3 shadow-sm">
                    ...
                    <p class="mb-1">Mohon luangkan waktu sejenak untuk <strong>memverifikasi kembali semua detail data</strong> yang telah Anda ajukan.</p>
                    <p class="mb-0">Jika data sudah <strong>Disetujui</strong>, data tidak dapat diubah lagi. Untuk permintaan perubahan, hubungi Administrator.</p>
                </div>
            @endif
            ...
            <div class="card shadow-sm card-export-actions flex-grow-1">
                <div class="card-body">
                    ...
                    <div class="export-buttons-group mt-auto">
                        ...
                        <a href="{{ route('tenagakerja.edit', $item->id) }}" class="btn btn-warning @if($item->status_validasi === 'validated') disabled @endif">
