...
<form action="{{ route('admin.tkw.update', $item->id) }}" method="POST" enctype="multipart/form-data" id="main-form">
    ...
    <fieldset @if($item->status_validasi === 'validated') disabled @endif>
        ...
        {{-- Ganti seluruh <div class="row"> pertama Anda dengan blok kode ini --}}
        <div class="row">
            {{-- ============================================= --}}
            {{-- KOLOM KIRI: GABUNGAN SEMUA INFORMASI DETAIL --}}
            {{-- ============================================= --}}
            <div class="col-lg-7">
                <div class="card shadow-sm mb-4" id="detail-card">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Detail Pendataan & Lokasi</h6>
                    </div>
                    <div class="card-body py-3 px-4">
                        ...
                        {{-- Bagian Ringkasan Rumah Tangga --}}
                        <h6 class="sub-header-info">Ringkasan Rumah Tangga:</h6>
                        <dl class="info-list-split mb-0">
                            <div class="row"><dt class="col-sm-8">Total Anggota</dt><dd class="col-sm-4 font-weight-bold">{{ $item->jart }}</dd></div>
                            <div class="row"><dt class="col-sm-8">Anggota Bekerja</dt><dd class="col-sm-4 font-weight-bold">{{ $item->jart_ab }}</dd></div>
                            <div class="row"><dt class="col-sm-8">Anggota Tidak Bekerja</dt><dd class="col-sm-4 font-weight-bold">{{ $item->jart_tb }}</dd></div>
                            <div class="row"><dt class="col-sm-8">Anggota Masih Sekolah</dt><dd class="col-sm-4 font-weight-bold">{{ $item->jart_ms }}</dd></div>
                        </dl>
