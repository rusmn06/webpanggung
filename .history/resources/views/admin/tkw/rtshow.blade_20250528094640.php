        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="dataTable" class="table table-bordered" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>Nama Anggota</th> {{-- Diubah --}}
                            <th>NIK</th>
                            <th>Status Validasi RT</th> {{-- Diubah --}}
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
...
@push('scripts')
    ...
    <script>
        $(function() {
            // Inisialisasi DataTables tanpa paging & info bawaan
            // karena kita sudah menggunakan Pagination Laravel
            $('#dataTable').DataTable({
                "paging":   false,
                "info":     false,
                "searching": true // Biarkan pencarian aktif
            });
        });
    </script>
@endpush