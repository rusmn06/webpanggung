...
@push('styles')
{{-- Mengambil semua style dari referensi Anda --}}
<style>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        {{-- PERUBAHAN 1: Judul dengan Badge --}}
        ...
        {{-- PERUBAHAN 2: Tombol Export ditambahkan di sini --}}
        <div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <div class="signature-box">
                        {{-- PERUBAHAN 5: Memperbaiki path gambar --}}
                        @if($item->ttd_pendata)
                ...
                <div class="col-md-6">
                     ...
                     <div class="signature-box">
                        {{-- PERUBAHAN 5: Memperbaiki path gambar --}}
                         @if($item->admin_ttd_pendata) {{-- Sesuaikan nama field jika berbeda --}}
