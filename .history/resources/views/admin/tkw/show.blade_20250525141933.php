...
<div class="container-fluid">
        ...
        <div class="col-lg-7 mb-4">
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p class="mb-2"><strong>Jmh. Anggota Rumah Tangga:</strong> {{ $item->jart }}</p>
                            <p class="mb-2"><strong>Jmh. Anggota Rumah Tangga Bekerja:</strong> {{ $item->jart_ab }}</p>
                            <p class="mb-0"><strong>Pendapatan Rumah Tangga/Bulan:</strong> {{ $item->jpr2rtp_text ?? $item->jpr2rtp }}</p>
                        </div>
                        @if($item->ttd_pendata)
                        <div class="col-md-6">
    ...
    <div class="row">
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 text-gray-800 mb-0">Data Anggota Keluarga</h1>
      </div>
