...
<style>
    ...
    .rt-card-simple .icon-area i {
        font-size: 1.75rem;
        color: #b7b9cc; /* Warna ikon lebih soft */
            ...
            <div class="row">
                @for ($i = 1; $i <= 24; $i++)
                    @php
                        ...
                        // Ambil count, jika tidak ada, beri nilai 0
                                ...
                                <div class="d-flex align-items-stretch h-100">
                                    ...
                                    <div class="text-area">
                                        ...
                                        <div class="rt-preview-data">
                                            <small>Responden: <strong>{{ $totalRT }}</strong></small>
                                            <small>Anggota: <strong>{{ $totalAnggota }}</strong></small>
                                        </div>
