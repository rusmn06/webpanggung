    ...
    <fieldset @if($item->status_validasi === 'validated') disabled @endif>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 mb-4">
                <div class="card shadow-sm h-100 d">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex">
                            <div class="custom-control custom-radio mr-4">
                                ...
                                <label class="custom-control-label" for="status_validated">Setujui</label>
                            </div>
                            ...
                            {{-- Pilihan untuk mengembalikan ke pending --}}
                            <div class="custom-control custom-radio ml-4">
                                <input type="radio" id="status_pending" name="status" value="pending" class="custom-control-input" @if(old('status', $item->status_validasi) == 'pending') checked @endif>
                                <label class="custom-control-label" for="status_pending">Pending</label>
                            </div>
                        </div>
                    </div>
                    {{-- Menggunakan optional() dan ?? untuk fallback jika data null --}}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateAllMemberNumbers() {
        ...
        forms.forEach((form, index) => {
            ...
            if (nukInput && !nukInput.value) nukInput.value = index + 1;
    ...
    // Hapus, validasi NIK, update recap
    if(container) {
    ...
    // Tombol confirm submit
    if (confirmButton && mainForm) {
