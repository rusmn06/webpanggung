...
<style>
    ...
    .sub-header-info { background-color: #f8f9fc; padding: 0.5rem 0.75rem; margin-top: 1rem; margin-bottom: 0; font-weight: bold; font-size: 0.9rem; color: #5a5c69; border-top: 1px solid #eaecf4; border-bottom: 1px solid #eaecf4; }
    #detail-card .card-body > .sub-header-info:first-of-type { margin-top: 0; border-top: none; }
        ...
        <div class="col-lg-5 mb-4">
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body d-flex flex-column">
                    <form id="verification-form" action="{{ route('admin.tkw.process', $item->id) }}" method="POST" enctype="multipart/form-data" class="flex-grow-1 d-flex flex-column">
                        @csrf
                        <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const tglInput = document.getElementById('admin_tgl_validasi');
    const namaInput = document.getElementById('admin_nama_kepaladusun');
    ...
    function updateFormState() {
        if (radioRejected.checked) {
            ...
            if(approvalFootnote) approvalFootnote.style.display = 'none';
            if(rejectionFootnote) rejectionFootnote.style.display = 'block';
            ...
            if(rejectionFootnote) rejectionFootnote.style.display = 'none';
            if(approvalFootnote) approvalFootnote.style.display = 'block';

            tglInput.disabled = false;
            tglInput.required = true;
            if (!tglInput.value) {
                tglInput.value = '{{ now()->toDateString() }}';
            }
    ...
    if(radioValidated && radioRejected) {
        updateFormState();
