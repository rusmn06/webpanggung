...
document.addEventListener('DOMContentLoaded', function() {
    $('#deleteModal').on('show.bs.modal', function (event) {
        ...
        var respondentName = button.data('name'); // Ambil nama dari data-name
        var submissionId = button.data('id'); // Ambil ID dari data-id

        var modal = $(this);
        modal.find('#respondent-name').text(respondentName);

        // Buat URL action untuk form delete
        var actionUrl = "{{ url('admin/tenagakerja') }}/" + submissionId + "/delete";
