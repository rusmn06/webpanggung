...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateFormState() {
        // Ambil elemen input di dalam fungsi agar selalu ter-update
        ...
        if (radioRejected.checked) {
            ...
            // Nonaktifkan & kosongkan field persetujuan
            tglInput.disabled = true;
            tglInput.required = false;
            tglInput.value = ''; // BARU: Kosongkan nilainya
            namaInput.disabled = true;
            namaInput.required = false;
            namaInput.value = ''; // BARU: Kosongkan nilainya
            ...
            // Aktifkan & isi field persetujuan
            tglInput.disabled = false;
            tglInput.required = true;
            tglInput.value = tglInput.value || '{{ now()->toDateString() }}'; // BARU: Isi tanggal jika kosong
            namaInput.disabled = false;
            namaInput.required = true;
            namaInput.value = namaInput.value || '{{ Auth::user()->name }}'; // BARU: Isi nama jika kosong
