            ...
            <div class="row">
                <div class="col-md-6 mb-3 mb-md-0"><p class="verification-title text-center">DIAJUKAN OLEH PENDATA</p>
                    ...
                    <div class="signature-box">
                        @if($item->ttd_pendata)<img src="{{ asset('storage/ttd/pendata/'.$item->ttd_pendata) }}" alt="TTD Pendata"><p class="signer-name mt-2">( {{ $item->verif_nama_pendata ?? 'Nama Pendata' }} )</p>@else<p class="text-muted my-4"><em>(Belum ada TTD)</em></p>@endif</div>
                </div>
