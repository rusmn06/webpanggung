...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-7 mb-4">
            <div class="card shadow-sm h-100"> {{-- Kartu independen 1 --}}
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p class="mb-2"><strong>Jml. Anggota RT:</strong> {{ $item->jart }}</p>
        ...
        <div class="col-lg-5 mb-4">
            <div class="card shadow-sm h-100"> {{-- Kartu independen 2 --}}
