...
@section('content')
    ...
    <div>
        ...
        <a href="{{ route('admin.tkw.edit', $rumahTangga->id) }}" class="btn btn-warning btn-sm">
            <i class="fas fa-pencil-alt"></i>
        </a>
        
        {{-- TOMBOL LAMA UNTUK LIHAT DETAIL --}}
        <a href="{{ route('admin.tkw.detail', $rumahTangga->id) }}" class="btn btn-info btn-sm">
