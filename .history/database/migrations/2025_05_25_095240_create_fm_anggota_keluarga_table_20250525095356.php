...
return new class extends Migration
{
    ...
    {
        Schema::create('fm_anggota_keluarga', function (Blueprint $table) { // <-- NAMA TABEL BARU
            $table->id();

            $table->unsignedBigInteger('rumah_tangga_id');
            // Pastikan foreign key menunjuk ke nama tabel yang benar
    ...
    {
        Schema::dropIfExists('fm_anggota_keluarga'); // <-- NAMA TABEL BARU
    }
};