...
class StoreTenagaKerjaRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'ttd_pendata' => 'required|image|mimes:jpeg,png,jpg|max:2048',

            // Validasi untuk Anggota Keluarga (Array)
            'nama' => 'required|array|min:1',
            'nama.*' => 'required|string|max:100',
            'nik' => 'required|array|min:1',
            // 'distinct' memastikan tidak ada NIK duplikat dalam satu pengajuan
            ...
            // Field nullable tidak perlu 'required' di level array
