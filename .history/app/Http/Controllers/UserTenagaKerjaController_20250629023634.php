...
class UserTenagaKerjaController extends Controller
{
    ...
    public function fixSequenceNumbers()
    {
        ...
        return "Proses selesa! Sebanyak " . $totalUpdated . " data pengajuan telah berhasil diperbarui dengan nomor urut yang benar. Anda sekarang bisa menghapus route dan metode sementara ini.";
    }
