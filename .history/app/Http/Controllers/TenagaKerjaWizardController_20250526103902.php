...
class TenagaKerjaWizardController extends Controller
{
    ...
    {
         \Illuminate\Support\Facades\Log::info('Memasuki postStep4. Data Sesi Step 1:', session('tk.step1', ['DATA STEP 1 KOSONG']));
         \Illuminate\Support\Facades\Log::info('Data Sesi Step 2:', session('tk.step2', ['DATA STEP 2 KOSONG']));
         \Illuminate\Support\Facades\Log::info('Data Sesi Step 3:', session('tk.step3', ['DATA STEP 3 KOSONG']));
        // Validasi Step 4
