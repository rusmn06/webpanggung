...
class TenagaKerjaVerifController extends Controller
{
    ...
    public function processVerification(Request $request, $id)
    {
        ...
        // 3. Handle file upload TTD jika ada
        ...
        // 4. Update data di database dengan data yang sudah divalidasi
        $item->update([
            ...
            'admin_tgl_validasi' => now(), // Tanggal validasi diisi otomatis saat ini
        ]);
