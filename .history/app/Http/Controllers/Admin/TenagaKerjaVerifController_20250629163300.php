...
class TenagaKerjaVerifController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        // Karena di migrasi Anda sudah ada onDelete('cascade'),
        // maka semua data anggota keluarga yang terkait akan ikut terhapus otomatis.
        // Ini sangat bagus!
        $item->delete();

        return redirect()->route('admin.tkw.listrt')
                         ->with('success', 'Data untuk responden ' . $item->nama_responden . ' telah berhasil dihapus.');
    }
