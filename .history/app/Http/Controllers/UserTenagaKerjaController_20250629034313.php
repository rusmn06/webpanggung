...
class UserTenagaKerjaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // 1. Terapkan filter berdasarkan STATUS jika ada
    if ($request->filled('status')) {
        $itemsQuery->where('status_validasi', $request->status);
    }

    // 2. Terapkan filter berdasarkan KATA KUNCI PENCARIAN jika ada
