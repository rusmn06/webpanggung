    ...
    public function exportExcel($id)
    {
        ...
        try {
            ...
            foreach ($anggotaKeluargaPertama9 as $index => $anggota) {
                if($index >= count($barisNamaBase)) break; // Tambahan keamanan jika anggota > 9 tapi array baris tidak cukup
                ...
                // DATA PENDAPATAN UNTUK KOLOM AY AKAN DIISI SESUAI KLARIFIKASI ANDA NANTI
                // $sheet->setCellValue('AY' . $barisInfoSaatIni, $anggota->pendapatan_per_bulan_text_atau_data_lain);
            }
