...
class TenagaKerjaController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::transaction(function () use ($validatedData, $request, &$rumahTangga) {
            ...
            return redirect()->route('tenagakerja.show', $rumahTangga->id)
                ...
                ->with('success_message_body', 'Data Anda (Pengajuan Ke-'.$rumahTangga->user_sequence_number.') berhasil dikirim dan sedang menunggu verifikasi.');

        } catch (ValidationException $e) {
            // Kembali ke halaman sebelumnya dengan error dan input lama
