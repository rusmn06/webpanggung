...
class UserTenagaKerjaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // FIX 2: Inisialisasi $itemsQuery di luar blok if agar selalu ada
        ...
        if ($request->filled('search')) {
            ...
            $itemsQuery->where(function($q) use ($searchTerm) {
                ...
                ->orWhere('user_sequence_number', $searchTerm);
            });
        }
    ...
    public function fixSequenceNumbers()
    {
        ...
        $userIds = \App\Models\RumahTangga::select('user_id')->distinct()->pluck('user_id');
        ...
        foreach ($userIds as $userId) {
            ...
            $submissions = \App\Models\RumahTangga::where('user_id', $userId)
        ...
        return "Proses selesai! Sebanyak " . $totalUpdated . " data pengajuan telah berhasil diperbarui dengan nomor urut yang benar. Anda sekarang bisa menghapus route dan metode sementara ini.";
    }
