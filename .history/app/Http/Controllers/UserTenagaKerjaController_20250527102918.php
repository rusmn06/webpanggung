    ...
    public function show($id)
{
    ...
    if ($itemSequenceIndex !== false) {
        $item->user_sequence_number = $itemSequenceIndex + 1; // Tambah 1 karena array_search 0-based
    } else {
        // Seharusnya tidak terjadi jika $item ditemukan dengan findOrFail
        // Namun, sebagai fallback jika ada kasus aneh
