    ...
    public function store(Request $request)
    {
        try {
            $validatedData = $request->validate([
                ...
                'jart.min' => 'Minimal harus ada 1 anggota keluarga.',
            ...
            return redirect()->route('tenagakerja.show', $rumahTangga->id)
                ...
                ->with('success_message_body', 'Data Anda (Pengajuan Ke-' . $rumahTangga->user_sequence_number . ') telah berhasil dikirim dan sedang menunggu verifikasi.');
