...
class UserTenagaKerjaController extends Controller
{
    ...
    public function exportExcel($id)
    {
        ...
        // Ganti semua karakter yang bukan huruf, angka, spasi, underscore, titik, atau strip dengan underscore
        ...
        $tanggalDownload = now()->format('Y-m-d'); // Contoh Format: 2025-06-09
        ...
        // LANGKAH DEBUGGING: Hentikan dan tampilkan nilai $namaFile
        dd($namaFile); 

        // Proses output file (kode di bawah ini tidak akan dijalankan untuk sementara)
