...
return redirect()->route('tenagakerja.index')
    ->with('success', 'Data pengajuan baru untuk responden ' . $rumahTangga->nama_responden . ' berhasil disimpan!')
    ->with('form_submitted', true); // <-- TAMBAHAN: Kirim sinyal ke view berikutnya
