...
use App\Models\RumahTangga; // Pastikan ini adalah model utama Anda
...
class TenagaKerjaExport implements WithEvents, ShouldAutoSize // NAMA CLASS SUDAH DIUBAH
{
    protected $rumahTangga;

    public function __construct(RumahTangga $rumahTangga)
    {
        $this->rumahTangga = $rumahTangga->load('anggotaKeluarga'); // Pastikan anggotaKeluarga sudah ter-load
    }
