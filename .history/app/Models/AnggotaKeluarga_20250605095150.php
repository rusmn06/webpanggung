...
class AnggotaKeluarga extends Model
{
    ...
    {
        // Kondisi if ($this->attributes['sub_jenis_pekerjaan'] == '1') dihilangkan karena switch sudah menangani nilai spesifik.
        // Anda mungkin ingin menambahkan kondisi terkait status_pekerjaan atau jenis_pekerjaan di sini jika relevan.
        // Misalnya, sub jenis pekerjaan hanya ada jika jenis pekerjaan adalah 'Karyawan, Honorer'.
        // Untuk saat ini, saya asumsikan sub_jenis_pekerjaan bisa ada secara independen (meski mungkin kurang logis).
        ...
        if (!isset($this->attributes['sub_jenis_pekerjaan']) || $this->attributes['sub_jenis_pekerjaan'] === null || $this->attributes['sub_jenis_pekerjaan'] === '') {
            // Jika sub_jenis_pekerjaan tidak diisi atau kosong, kembalikan strip atau teks lain.
            // Ini juga mencegah error jika 'sub_jenis_pekerjaan' tidak ada di $attributes.
            return '-';
        }

        // Logika sebelumnya: if ($this->attributes['sub_jenis_pekerjaan'] == '1') { switch ... }
        // Ini berarti hanya jika sub_jenis_pekerjaan adalah '1', maka switch dijalankan, yang tidak masuk akal
        // karena case '2', '3', dst. tidak akan pernah tercapai.
        // Switch harusnya langsung pada nilai atributnya.
        switch ($this->attributes['sub_jenis_pekerjaan']) {
            ...
            case '5': return 'Lainnya';
            default: return 'Sub Jenis Pekerjaan Tidak Terdefinisi'; // Atau '-' jika lebih sesuai
        }
    }
     ...
     * Menggunakan logika yang Anda berikan untuk 'jpr2rtp' dan diterapkan pada 'pendapatan_per_bulan'.
     */
    public function getPendapatanPerBulanTextAttribute(): string
    {
        if (!isset($this->attributes['pendapatan_per_bulan'])) {
             // Menangani kasus jika atribut tidak diset, meskipun ada di $fillable
        ...
        switch ($this->attributes['pendapatan_per_bulan']) {
            ...
            case '1':
                // Sesuaikan teks ini jika rentang pendapatan berbeda atau jika '1' berarti nilai eksak.
                // Berdasarkan contoh sebelumnya, 'di Atas Rp X' mungkin lebih cocok untuk rentang.
                // Jika '1' adalah kategori untuk "> Rp 500.000", maka teksnya sudah sesuai.
            ...
            // Pertimbangkan menambahkan case untuk nilai lain jika ada, atau jika nilai yang disimpan adalah angka sebenarnya.
            // Jika 'pendapatan_per_bulan' menyimpan nilai aktual (misal 750000), maka switch case seperti ini tidak cocok.
            // Switch case ini cocok jika 'pendapatan_per_bulan' menyimpan KODE kategori pendapatan (0, 1, 2, 3, 4).
            default:
                return 'Tidak Diketahui/Kosong'; // Atau 'Data Tidak Terverifikasi' agar konsisten
        }
    }
}