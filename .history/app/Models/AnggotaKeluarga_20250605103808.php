...
class AnggotaKeluarga extends Model
{
    ...
    {
        // Langsung periksa jenis_pekerjaan, tanpa pengecekan status_pekerjaan.
        if (!isset($this->attributes['jenis_pekerjaan']) || $this->attributes['jenis_pekerjaan'] === null || $this->attributes['jenis_pekerjaan'] === '') {
            // Jika jenis_pekerjaan tidak diisi, null, atau string kosong.
            return '-'; // Atau 'Jenis Pekerjaan Tidak Diisi', 'Data Tidak Tersedia', dll.
        }

        // Jika jenis_pekerjaan ada nilainya, lanjutkan ke switch.
