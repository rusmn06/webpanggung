...
class RumahTangga extends Model
{
    ...
    public function getJpr2rtpTextAttribute(): string
    {
        ...
        switch ($this->attributes['jpr2rtp']) {
            ...
            case '1':
                return 'Pendapat Rumah Tannga di Atas Rp 500.000';
            case '2':
                return 'Pendapat Rumah Tannga di Atas Rp 1.000.000';
            case '3':
                return 'Pendapat Rumah Tannga di Atas Rp 2.000.000';
            case '4':
                return 'Pendapat Rumah Tannga di Atas Rp 4.000.000';
            default:
