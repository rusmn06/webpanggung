...
class RumahTangga extends Model
{
    ...
    protected $table = 'fm_rumah_tangga'; // <-- UBAH NAMA TABEL DI SINI

    // $fillable, $casts, relasi, dan accessor lainnya tetap sama
    protected $fillable = [
    ...
    {
        return $this->hasMany(AnggotaKeluarga::class); // Model AnggotaKeluarga tidak berubah namanya
    }
