...
// use Illuminate\Database\Eloquent\Casts\Attribute; // Tidak perlu ini jika menggunakan gaya accessor lama
...
class RumahTangga extends Model
{
    ...
    protected $fillable = [
        ...
        'jart', 'jart_ab', 'jart_tb', 'jart_ms', 'jpr2rtp', // <-- jpr2rtp ada di sini
        'verif_tgl_pembuatan', 'verif_nama_pendata', 'ttd_pendata',
        'status_validasi', // <-- status_validasi ada di sini
        'user_id',
    ...
    // --- MULAI TAMBAHKAN ACCESSOR DI SINI ---

    /**
     * Accessor untuk mendapatkan teks dari JPR2RTP (Pendapatan Rata-Rata RT/Bulan).
     * GANTI TEKS ('< Rp 500.000', dst.) SESUAI KEBUTUHAN ANDA.
     * Nama method: getNamaKolomTextAttribute (NamaKolom dalam CamelCase)
     * Cara panggil nanti: $rumahTangga->jpr2rtp_text
     */
