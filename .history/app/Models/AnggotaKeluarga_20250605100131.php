...
class AnggotaKeluarga extends Model
{
    ...
    public function getPendidikanTerakhirTextAttribute(): string
    {
        switch ($this->attributes['pendidikan_terakhir']) {
            ...
            case '4':
                return 'Tamat SMA/Sederajat';
            case '5':
                return 'Tamat Perguruan Tinggi (Diploma,S1, S2, S3)';
            case '6':
        ...
        if (isset($this->attributes['status_pekerjaan']) && $this->attributes['status_pekerjaan'] == '1') {
            ...
            switch ($this->attributes['jenis_pekerjaan']) {
                ...
                case '4':
                    return 'Lainnya';
                default:
                    return 'Jenis Pekerjaan Tidak Terdefinisi';
            }
        }
        return '-';
    }
    ...
    public function getSubJenisPekerjaanTextAttribute(): string
    {
        ...
        switch ($this->attributes['sub_jenis_pekerjaan']) {
            case '1':
                return 'Aparatur Pemerintah/Negara';
            case '2':
                return 'Tenaga Ahli/Professional';
            case '3':
                return 'Tenaga Kerja Harian';
            case '4':
                return 'Pengusaha/Wira Usaha';
            case '5':
                return 'Lainnya';
            default:
                return 'Sub Jenis Pekerjaan Tidak Terdefinisi';
        }
    }
