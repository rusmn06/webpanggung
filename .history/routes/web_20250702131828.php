...
Route::middleware(['auth', 'role:user|admin'])->group(function () {
    ...
    Route::prefix('kuesioner-tenaga-kerja')->name('tenagakerja.')->group(function () {
        ...
        Route::get('/kuesioner-tenaga-kerja/{id}/edit', [TenagaKerjaController::class, 'edit'])->name('tenagakerja.edit');
        Route::put('/kuesioner-tenaga-kerja/{id}', [TenagaKerjaController::class, 'update'])->name('tenagakerja.update');
