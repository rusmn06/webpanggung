    ...
    ->group(function () {
        ...
        Route::prefix('tenagakerja')
            ...
            ->group(function () {
                ...
                // --- Rute Dinamis dengan Parameter {id}, dari Paling Spesifik ke Paling Umum ---
                
                // Pola /{id}/edit lebih spesifik dari /{id}
                Route::get('/{id}/edit', [TenagaKerjaVerifController::class, 'edit'])->name('edit');
                
                // Rute untuk proses form (metode PUT dan POST)
                ...
                // Rute /{id} adalah yang paling umum, letakkan di PALING BAWAH
