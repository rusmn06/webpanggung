     ...
     ->group(function () {
        ...
        Route::prefix('tenagakerja')
            ...
            ->group(function () {
                ...
                // == TEMPATKAN ROUTE SPESIFIK DI ATAS ==
                ...
                Route::get('/rt/{rt}',          [TenagaKerjaVerifController::class, 'showRtData'])->name('showrt')
                                                ->where('rt', '[0-9]+');
                Route::get('/tes', function () { // Jika kamu masih punya route tes, taruh di sini juga
                    return "HALO INI TES ROUTE TKW!";
                })->name('tes');
                // =======================================

                // == BARU TEMPATKAN ROUTE DENGAN PARAMETER {id} DI BAWAH ==
