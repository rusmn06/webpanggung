     ...
     ->group(function () {
         ...
         Route::prefix('tenagakerja')
              ...
              ->group(function () {
                  ...
                  Route::get('/list-rt',          [TenagaKerjaVerifController::class, 'listRtPage'])->name('listrt'); // Halaman pilih RT
                    Route::get('/rt/{rt}',          [TenagaKerjaVerifController::class, 'showRtData'])->name('showrt') // Halaman detail 1 RT
                                                ->where('rt', '[0-9]+'); // Pastikan {rt} adalah angka
              });
