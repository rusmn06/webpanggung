         ...
         // Verifikasi tenaga kerja
          Route::prefix('tenagakerja')
             ...
             ->group(function () {
                ...
                // --- RUTE BARU (Hanya 1 ini) ---
                Route::get('/get-rt-data/{rt}', [TenagaKerjaVerifController::class, 'getRtData'])->name('getrtdata')
                     ->where('rt', '[0-9]+');
                // --- AKHIR RUTE BARU ---

                // --- RUTE LAMA ---
                // Route 'index' sekarang akan menampilkan halaman gabungan
                Route::get('/',              [TenagaKerjaVerifController::class, 'index'])->name('index');
                // Route berikut mungkin tidak akan dipakai lagi, tapi biarkan saja dulu
                ...
                Route::get('/rt/{rt}',       [TenagaKerjaVerifController::class, 'showRtData'])->name('showrt')
                     ->where('rt', '[0-9]+');
                // Route ini masih dipakai untuk tombol 'Lihat' di tabel
