...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Ubah Akun</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.user.update', $user->id) }}" method="POST">
                ...
                <div class="row">
                    <!-- PASSWORD (optional: kosongkan kalau tidak ingin ganti) -->
                    <div class="col-lg-6 mb-3 position-relative">
                        <label for="password">Password Baru <small class="text-muted">(kosongkan untuk tidak berubah)</small></label>
